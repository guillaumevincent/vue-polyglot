(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Polyglot"] = factory();
	else
		root["Polyglot"] = factory();
})(this, function() {
      ...
      vm = new Vue({
        ...
        methods: {
          ...
          setLocale: function setLocale(_ref3) {
            ...
            this.locales = (0, _assign2.default)({}, this.locales, (0, _defineProperty3.default)({}, lang, locale));
          },
          getLang: function getLang() {
            ...
            return _i18n2.default.getBestLanguage(languagesAvailable, navigatorLanguage, defaultLanguage);
          },
          getLocale: function getLocale() {
            ...
            if (lang !== options.defaultLanguage) {
              _axios2.default.get(baseURL + '/' + lang + '.json').then(function (response) {
          ...
          _t: function _t(key, fallbackMessage, data) {
            return _i18n2.default.translate(this.locale, key, fallbackMessage, data);
          }
        }
      });
